...
/*        let weatherForecast = CurrentMood(tempature: 35.32, precipitation: 45.21, summary: "Sunny", humidity: 83.12, img: "rain")
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        self.userLongitude = locationValue.longitude
        self.userLatitude = locationValue.latitude
        
        print(userLatitude)
        print(userLongitude)
        

//    getData is called here because the coordinate information is retrieved here.
        getData()
...
//        indicater stop
    ...
    func getData(){
        ...
        //        guard let means if it satisfies the condition
                guard let requestURL = URL(string: "\(userLatitude),\(userLongitude)", relativeTo: baseURL) else { return  }
